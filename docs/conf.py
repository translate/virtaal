...
# module is the single source of truth, this is documentation-facing only.
#
...
latex_documents = [
  ('index', 'Virtaal.tex', 'Virtaal Documentation',
   'Translate', 'manual'),
]
...
man_pages = [
    ('index', 'virtaal', 'Virtaal Documentation',
     ['Translate'], 1)
]
...
texinfo_documents = [
  ('index', 'Virtaal', 'Virtaal Documentation',
   'Translate', 'Virtaal', 'Powerful, uncluttered XLIFF and PO editor.',
   'Miscellaneous'),
]
