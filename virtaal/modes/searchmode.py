...
class SearchMode(BaseMode):
    ...
    def _create_widgets(self):
        ...
        self.btn_search = Gtk.Button.new_with_label(_('Search'))
        ...
        # l10n: Button text
        self.btn_replace = Gtk.Button.new_with_label(_('Replace'))
    ...
    def _setup_key_bindings(self):
        ...
        Gtk.AccelMap.add_entry("<Virtaal>/Edit/Search: Previous", Gdk.KEY_G, Gdk.ModifierType.CONTROL_MASK | Gdk.ModifierType.SHIFT_MASK)
    ...
    def _on_style_set(self, widget, prev_style):
        self.default_base = widget.get_style().base[Gtk.StateType.NORMAL]
        self.default_text = widget.get_style().text[Gtk.StateType.NORMAL]
        self.ent_search.modify_base(Gtk.StateType.NORMAL, self.default_base)
        self.ent_search.modify_text(Gtk.StateType.NORMAL, self.default_text)
