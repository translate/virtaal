...
class TMWindow(Gtk.Window):
    ...
    def update_geometry(self, widget):
        ...
        self.get_window().move_resize(0,0, width,height)
        self.get_window().get_toplevel().move_resize(x,y, width,height)
    ...
    def _percent_data_func(self, column, cell_renderer, tree_model, iter, user_data):
        ...
        if match_data.get('quality', None) is not None:
            ...
            return
        elif Gtk.check_version(2,16,0) is not None:
...
class TMSourceColRenderer(Gtk.CellRenderer):
    ...
    def do_get_size(self, widget, cell_area):
        ...
        return 0, 0, size.width, size.height + self.YPAD*2
...
class TMMatchRenderer(Gtk.CellRenderer):
    ...
    def do_render(self, window, widget, _background_area, cell_area, _expose_area, _flags):
        ...
        widget.get_style().paint_box(window, Gtk.StateType.NORMAL, Gtk.ShadowType.IN,
