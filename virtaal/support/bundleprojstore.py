...
# translate/storage/bundleprojstore.py, at:
#   repo:      https://github.com/translate/translate
#   tag:       3.18.1
#   commit:    69d2f2f25632b91f2ef80b43e4c1f7d5c9331b1b
#   blob sha:  baae1a8a3ead9e21630204e15cdc566c2c27bd83
# Removed from translate-toolkit between releases 3.18.1 and 3.19.0
# ("chore: drop project storage - This was not used by any tools and is
# not maintained", issue translate/translate#4018), along with its
# siblings project.py and projstore.py.
...
from virtaal.support.projstore import FileNotInProjectError, ProjectStore
