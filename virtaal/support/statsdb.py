...
# translate/storage/statsdb.py, at:
#   repo:      https://github.com/translate/translate
#   tag:       2.5.1
#   commit:    1dc4f89bdb35edc71177eb23533764b06532db11
#   blob sha:  de64169db162aaeffdaff591a475fc6ba68bd3fd
# This module was removed from translate-toolkit with no replacement
# between releases 3.2.0 and 3.3.0 (early 2021); nothing below this
# banner has been altered yet in this commit. See the follow-up commit
# for the Python-3-only adaptation (dropping the six dependency).
